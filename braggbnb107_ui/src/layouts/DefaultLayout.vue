...
-->>
				...
				<a-menu-item>
					<router-link to="/hostResponses">
						<span class="label">Host Responses</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/cancellationPolicys">
						<span class="label">Cancellation Policys</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/identityVerifications">
						<span class="label">Identity Verifications</span>
					</router-link>
				</a-menu-item>
