...
<template>
  ...
  <base-input label="Seen" type="text" placeholder="Enter Seen" v-model="notificationToAdd.seen"></base-input>
                  </form>
                </div>
	...
	<template slot="seen" slot-scope="dataIndex">
       {{ dataIndex ? 'Yes' : 'No' }}
   </template>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'seen',
          ...
          //sorter: (a, b) => a.seen.localeCompare(b.seen),
        },
      ],
      pagination: {
        current: 1,
