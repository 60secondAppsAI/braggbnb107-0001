...
<template>
  ...
  <base-input label="NightlyRate" type="text" placeholder="Enter NightlyRate" v-model="listingToAdd.nightlyRate"></base-input>
  <base-input label="CleaningFee" type="text" placeholder="Enter CleaningFee" v-model="listingToAdd.cleaningFee"></base-input>
  <base-input label="Availability" type="text" placeholder="Enter Availability" v-model="listingToAdd.availability"></base-input>
                  </form>
                </div>
	...
	<template slot="availability" slot-scope="dataIndex">
       {{ dataIndex ? 'Yes' : 'No' }}
   </template>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'nightlyRate',
          visible: true,
          scopedSlots: { customRender: 'nightlyRate' },
          sorter: true
          //sorter: (a, b) => a.nightlyRate - b.nightlyRate,
          //sorter: (a, b) => a.nightlyRate.localeCompare(b.nightlyRate),
        },
        {
          title: 'Cleaning Fee',
		dataIndex: 'cleaningFee',
          visible: true,
          scopedSlots: { customRender: 'cleaningFee' },
          sorter: true
          //sorter: (a, b) => a.cleaningFee - b.cleaningFee,
          //sorter: (a, b) => a.cleaningFee.localeCompare(b.cleaningFee),
        },
        {
          title: 'Availability',
